      ...
      >
        ...
        <View style={{
            ...
            {(props.scoreA === 0 && props.scoreB === 0) && (
              ...
              >
                <StyledText type="bold" style={{ color: "white", fontSize: sizes.large.fontSize }}>
                  You've made the first vote.
              </StyledText>
                <StyledText style={{ color: "white", fontSize: sizes.medium.fontSize }}>
                  So far you are 100%!
              </StyledText>
              </View>
            )}
...
const VotePercents = (props) => {
  ...
  return props.score === "A" ? (
      ...
      <View style={{...borderStyles,borderColor: borderColors.borderA }}>
          <View style={{flexDirection:'row', height:normalize(40), width: normalize(60),justifyContent:'center'}}>
            <StyledText type={'bold'} style={{ ...textStyles,alignSelf:'flex-end' }}>
              {((props.scoreA / (props.scoreA + props.scoreB)) * 100).toFixed()}
            </StyledText>
            <StyledText style={{...textStyles, fontSize:sizes.small.fontSize, alignSelf:'flex-end', marginBottom:normalize(5)}}>%</StyledText>
          </View>
      </View>
